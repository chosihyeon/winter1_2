<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <header>
        ...
        <div class="logo-nav">
            <div class="logo">
                <img src="/MovieReview/resources/images/GHIBLIPedia.svg" alt="Ghibli Pedia Logo">
            </div>
            <nav class="nav-links">
        ...
        <!-- 회원가입 및 로그인 링크 -->
        <nav class="nav-links">
            <a href="/MovieReview/user/register.do">회원가입</a>
            <a href="/MovieReview/user/login.do">로그인</a>
        </nav>
    </header>
